...
(excl:defsystem :RDF (:pretty-name "RDF subsystem of SWCLOS"
  ...
  (:module :rdferror     "RDF/rdferror"     (:load-before-compile :Utils))
  (:module :NameSpace    "RDF/NameSpace"    (:load-before-compile :IRI))
  (:module :Literal      "RDF/Literal"      (:load-before-compile :Utils :Xml))
  (:module :RDFShare     "RDF/RDFShare"     (:load-before-compile :RdfIO :NameSpace))
  (:module :RdfParser    "RDF/RdfParser"    (:load-before-compile :NameSpace :RDFShare))
  (:module :RdfReader    "RDF/RdfReader"    (:load-before-compile :RdfParser))
  (:module :rdfnode0     "RDF/node0"        (:load-before-compile :IRI))
...
(excl:defsystem :RDFS (:pretty-name "RDFS subsystem of SWCLOS"
  ...
  (:module :RDFboot2     "RDFS/RDFboot2"     (:load-before-compile :RDF :RDFboot1))
  (:module :RDFboot      "RDFS/RDFboot"      (:load-before-compile :RDF :RDFboot2))
  ...
  (:module :GxForwardRef "RDFS/GxForwardRef" (:load-before-compile :RDF :GxType :DomainRange :RdfsKernel))
  (:module :RdfsKernel   "RDFS/RdfsKernel"   (:load-before-compile :RDF :SlotDef :RDFboot :GxForwardRef))
