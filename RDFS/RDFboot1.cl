...
;;;
;;; <direct-slot-definition-class> returns a direct slot definition class for target class. 
...
;;; (defclass C5 (C4 C2) ())
;;; (slot-definition-type (first (compute-slots (find-class 'C5))))
;;;  -> (and float fixnum)
;;; ----------------------------------------------------------------------------------
