...
(defun %owl-disjoint-p (c1 c2)
  ...
  (cond ((equal c1 c2) (values nil t))
        ...
        ((and (slot-exists-p c2 'disjoint-classes) (slot-boundp c2 'disjoint-classes)
         ...
         (values t t))
        ((c2cl:subtypep c1 c2) (values nil t))
        ((c2cl:subtypep c2 c1) (values nil t))
        ...
        ((and (owl-oneof-p c1) (owl-oneof-p c2))
         (let ((c1-ones (slot-value c1 '|owl|:|oneOf|))
           ...
           (cond ((intersection c1-ones c2-ones :test #'%owl-same-p)
                  (values nil t))
                 (t (values t t)))))
        (t (let ((supers1 (remove-if #'owl-restriction-p (class-direct-superclasses c1)))
                 (supers2 (remove-if #'owl-restriction-p (class-direct-superclasses c2))))
...
(defun %restriction-disjoint-p (c1 c2)
  (let ((role1 (node-name (slot-value c1 '|owl|:|onProperty|)))
    ...
    (cond ((c2cl:typep c1 |owl|:|hasValueRestriction|)
           (cond ((c2cl:typep c2 |owl|:|someValuesFromRestriction|) (values t t))
                 ((c2cl:typep c2 |owl|:|allValuesFromRestriction|) (values t t))
                 ((c2cl:typep c2 |owl|:|hasValueRestriction|)
                  (some #'(lambda (fil1)
                            (some #'(lambda (fil2)
                        ...
                        (mklist (slot-value c1 '|owl|:|hasValue|))))
                 ((error "Cant happen"))))
          ((c2cl:typep c1 |owl|:|someValuesFromRestriction|)
           (cond ((c2cl:typep c2 |owl|:|hasValueRestriction|) (values t t))
                 ((c2cl:typep c2 |owl|:|allValuesFromRestriction|) (values t t))
                 ((c2cl:typep c2 |owl|:|someValuesFromRestriction|)
                  (some #'(lambda (fil1)
                            (some #'(lambda (fil2) 
                        ...
                        (mklist (slot-value c1 '|owl|:|someValuesFrom|))))
                 ((error "Cant happen"))))
          ((c2cl:typep c1 |owl|:|allValuesFromRestriction|)
           (cond ((c2cl:typep c2 |owl|:|hasValueRestriction|) (values t t))
                 ((c2cl:typep c2 |owl|:|someValuesFromRestriction|) (values t t))
                 ((c2cl:typep c2 |owl|:|allValuesFromRestriction|)
